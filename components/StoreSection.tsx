                            ...
                            <div className="mt-6 px-1 space-y-5">
                                <div className="flex items-start justify-between">
                                    <div className="space-y-1">
                                        <h3 className="text-lg font-bold text-zinc-900 tracking-tight leading-none capitalize">
                                        ...
                                        <div className="flex flex-wrap gap-2 pt-1">
                                            ...
                                            {(new Date().getTime() - new Date(product.createdAt).getTime() < 7 * 24 * 60 * 60 * 1000) && (
                                                <span className="px-3 py-1 bg-rose-50 text-rose-600 rounded-full text-[9px] font-bold uppercase tracking-widest">
                                                    New
                                                </span>
                                            )}
                                        </div>
